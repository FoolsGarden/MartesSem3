...
# Utiliza: Enumerable#select ([3, 4, 7, 9, 10, 16]) == [3, 7, 9]
...
# # Utiliza: Enumerable#find ([13, 21, 7, 0, 11, 106], 10) == 7
...
# # Utiliza: Enumerable#map (["hi", "mom"]) == ["hi!", "mom!"]
 def add_bang(array)
  array.map { |word| word += "!"  }
 end
...
# # Repite el ejercicio con Enumerable#inject ([1, 1, 2, 3, 5]) == 12
...
# # Utiliza: Enumerable#each_slice
 def sorted_triples(array)
  new_array = []
  array.each_slice(3) do |each_three| 
    new_array << each_three.sort
  end
   new_array
 end
